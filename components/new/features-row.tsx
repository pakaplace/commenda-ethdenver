...
import {
  Box, SimpleGrid, Icon, Text, Stack, Flex, useColorModeValue,
    ...
    <Box p={4}>
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10}>
        <Feature
          ...
          text="Stake your $POKT rewards daily instead of monthly. We automatically roll your rewards into new nodes."
        />
        <Feature
          icon={<Icon as={FcDonate} w={10} h={10} />}
          title="Daily Reward Payments"
          text="Receive rewards daily to your designated pocket wallet."
        />
        <Feature
          icon={<Icon as={FcCheckmark} w={10} h={10} />}
          title="Low Minimums"
          text="Start with as little as 1,000 $POKT and own a fractional share of our pool."
        />
      </SimpleGrid>
    </Box>
  );
